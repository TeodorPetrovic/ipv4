import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, defineAsyncComponent, defineComponent, ref, h, Suspense, Fragment, createApp, provide, shallowReactive, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, shallowRef, isReadonly, computed, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { B as defuFn, C as klona, D as parseURL, E as encodePath, F as decodePath, c as createError$1, G as defu, H as hasProtocol, I as isScriptProtocol, z as joinURL, J as withQuery, K as createDefu, L as sanitizeStatusCode, M as getContext, $ as $fetch$1, N as baseURL, O as createHooks, P as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "test",
    path: "/test",
    component: () => import('./test-CMKE2c5i.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-LwEAinSN.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BaYx3zgK.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-Om8CpO4j.mjs')
  },
  {
    name: "results",
    path: "/results",
    component: () => import('./results-GuzskJVQ.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-BOwImKzn.mjs').then((n) => n.i).then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ChoRm1lC.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CIr2LIQt.mjs'));
...
export { _export_sfc as _, appConfig as a, useNuxtApp as b, useAppConfig as c, useRouter as d, entry_default as default, encodeRoutePath as e, fetchDefaults as f, get as g, useRuntimeConfig as h, nuxtLinkDefaults as i, asyncDataDefaults as j, createError as k, looseToNumber as l, mergeConfig as m, navigateTo as n, omit as o, resolveRouteObject as r, twMerge as t, useHead as u };
