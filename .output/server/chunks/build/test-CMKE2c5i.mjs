import { _ as __nuxt_component_1, a as __nuxt_component_0, b as __nuxt_component_0$2 } from './Button-4AGFzmMi.mjs';
...
import { u as useFetch } from './fetch-C4-Qf9a6.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const gateStatus = computed(() => {
      ...
      if (!(cfg == null ? void 0 : cfg.start_date) || !(cfg == null ? void 0 : cfg.end_date)) return "open";
    ...
    async function startTest() {
      ...
      try {
        ...
        loadError.value = ((_a = e.data) == null ? void 0 : _a.message) || "Failed to load test";
      } finally {
        loading.value = false;
      }
    }
    async function submitAnswers() {
      ...
      try {
        ...
        loadError.value = ((_a = e.data) == null ? void 0 : _a.message) || "Failed to submit";
      } finally {
...
//# sourceMappingURL=test-CMKE2c5i.mjs.map
