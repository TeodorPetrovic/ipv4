    ...
    <div v-if="data" class="grid gap-6 lg:grid-cols-[280px_minmax(0,1fr)]">
      <aside class="lg:sticky lg:top-6 lg:self-start space-y-4">
        <UCard class="bg-muted">
          <template #header>
            <div>
              <h2 class="mt-2 text-lg font-semibold text-highlighted">{{ t('ipConverter.title') }}</h2>
            </div>
          </template>
        ...
        <div class="rounded-lg border border-default bg-elevated px-4 py-3">
          <p class="font-bold uppercase tracking-wide">{{ t('timer.remainingTime') }}</p>
          <ClientOnly>
              ...
              <table class="w-full table-fixed text-sm">
                <thead class="border-b border-default bg-muted/30">
                  <tr>
                    ...
                    <th class="px-4 py-3 text-center text-xs font-semibold text-muted">{{ t('levels.level1.decimalAnswer') }}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
              ...
              <table class="w-full table-fixed text-sm">
                <thead class="border-b border-default bg-muted/30">
                  <tr>
                    ...
                    <th class="px-4 py-3 text-center text-xs font-semibold text-muted">{{ t('levels.level4.usableHosts') }}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
              ...
              <table class="w-full table-fixed text-sm">
                <thead class="border-b border-default bg-muted/30">
                  <tr>
                    ...
                    <th class="px-4 py-3 text-center text-xs font-semibold text-muted">{{ t('levels.level5.usableOnInternet') }}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
              ...
              <table class="w-full table-fixed text-sm">
                <thead class="border-b border-default bg-muted/30">
                  <tr>
                    ...
                    <th class="px-4 py-3 text-center text-xs font-semibold text-muted">{{ t('levels.level6.sameNetwork') }}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
