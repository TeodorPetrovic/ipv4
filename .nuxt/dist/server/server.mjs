import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, ref, computed, defineComponent, provide, h, Suspense, Fragment, useSSRContext, unref, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/runner/work/ipv4/ipv4/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/runner/work/ipv4/ipv4/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/runner/work/ipv4/ipv4/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/home/runner/work/ipv4/ipv4/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu, defuFn, createDefu } from "/home/runner/work/ipv4/ipv4/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "/home/runner/work/ipv4/ipv4/node_modules/ufo/dist/index.mjs";
import { createSharedComposable } from "@vueuse/core";
import { extendTailwindMerge } from "tailwind-merge";
import { klona } from "/home/runner/work/ipv4/ipv4/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/home/runner/work/ipv4/ipv4/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "test",
    path: "/test",
    component: () => import("./_nuxt/test-CMKE2c5i.js")
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import("./_nuxt/admin-LwEAinSN.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BaYx3zgK.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-Om8CpO4j.js")
  },
  {
    name: "results",
    path: "/results",
    component: () => import("./_nuxt/results-GuzskJVQ.js")
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-BOwImKzn.js").then((n) => n.i).then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-ChoRm1lC.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CIr2LIQt.js"));
