import { u as useUI, d as useFormGroup, a as __nuxt_component_0$1, b as __nuxt_component_0$2, c as useInjectButtonGroup, _ as __nuxt_component_1 } from "./Button-4AGFzmMi.js";
import { useId as useId$1, mergeProps, defineComponent, toRef, computed, useSSRContext, toRaw, withAsyncContext, ref, withCtx, createTextVNode, unref, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList } from "vue";
import { twJoin } from "tailwind-merge";
import { _ as _export_sfc, t as twMerge, a as appConfig, m as mergeConfig, g as get } from "../server.mjs";
...
import { defu } from "/home/runner/work/ipv4/ipv4/node_modules/defu/dist/defu.mjs";
...
import { upperFirst } from "/home/runner/work/ipv4/ipv4/node_modules/scule/dist/index.mjs";
...
const _sfc_main$2 = defineComponent({
  ...
  props: {
    ...
    expandButton: {
      type: Object,
      default: () => config$1.default.expandButton
    },
    expand: {
      type: Object,
      default: () => null
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: sessions, refresh } = ([__temp, __restore] = withAsyncContext(() => useFetch(
      "/api/results",
      "$kb5bYnIJcS"
      /* nuxt-injected */
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gray-50 p-6" }, _attrs))}><div class="max-w-6xl mx-auto"><div class="flex items-center justify-between mb-6"><h1 class="text-2xl font-bold text-gray-900">Student Results</h1><div class="flex gap-2">`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UTable, {
              ...
              "percentage-data": withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UBadge, {
                    color: badgeColor(row)
                  }, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(row.percentage)}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(row.percentage), 1)
                        ];
                      }
                    }),
                    _: 2
      ...
      if (unref(selected)) {
        _push(ssrRenderComponent(_component_UCard, { class: "mt-6" }, {
          header: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h2 class="font-semibold"${_scopeId}>Tasks for ${ssrInterpolate(unref(selected).student_name)} (${ssrInterpolate(unref(selected).student_id)})</h2>`);
            } else {
              return [
                createVNode("h2", { class: "font-semibold" }, "Tasks for " + toDisplayString(unref(selected).student_name) + " (" + toDisplayString(unref(selected).student_id) + ")", 1)
              ];
            }
          }),
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="space-y-4 text-sm"${_scopeId}><div${_scopeId}><p class="font-semibold text-gray-700 mb-1"${_scopeId}>Level 1 – Binary→Decimal</p><p class="font-mono text-gray-600"${_scopeId}>${ssrInterpolate(unref(selected).tasks.level1?.[0]?.binary)} → ${ssrInterpolate(unref(selected).tasks.level1?.[0]?.decimal)}</p></div><div${_scopeId}><p class="font-semibold text-gray-700 mb-1"${_scopeId}>Level 2 – IP Class</p><!--[-->`);
              ssrRenderList(unref(selected).tasks.level2, (t, i) => {
                _push2(`<p class="font-mono text-gray-600"${_scopeId}>${ssrInterpolate(t.ip)} → ${ssrInterpolate(t.class)}</p>`);
              });
              _push2(`<!--]--></div><div${_scopeId}><p class="font-semibold text-gray-700 mb-1"${_scopeId}>Level 3 – Network/Broadcast</p><!--[-->`);
              ssrRenderList(unref(selected).tasks.level3, (t, i) => {
                _push2(`<p class="font-mono text-gray-600"${_scopeId}>${ssrInterpolate(t.hostIp)} → Net: ${ssrInterpolate(t.networkAddr)}, BC: ${ssrInterpolate(t.broadcastAddr)}</p>`);
              });
              _push2(`<!--]--></div><div${_scopeId}><p class="font-semibold text-gray-700 mb-1"${_scopeId}>Level 4 – Host Count</p><!--[-->`);
              ssrRenderList(unref(selected).tasks.level4, (t, i) => {
                _push2(`<p class="font-mono text-gray-600"${_scopeId}>${ssrInterpolate(t.mask)} → ${ssrInterpolate(t.hostCount)} hosts</p>`);
              });
              _push2(`<!--]--></div><div${_scopeId}><p class="font-semibold text-gray-700 mb-1"${_scopeId}>Level 5 – Same Network</p><!--[-->`);
              ssrRenderList(unref(selected).tasks.level5, (t, i) => {
                _push2(`<p class="font-mono text-gray-600"${_scopeId}>${ssrInterpolate(t.ip1)} &amp; ${ssrInterpolate(t.ip2)} / ${ssrInterpolate(t.mask)} → ${ssrInterpolate(t.sameNetwork ? "Yes" : "No")}</p>`);
              });
              _push2(`<!--]--></div><div${_scopeId}><p class="font-semibold text-gray-700 mb-1"${_scopeId}>Level 6 – VLSM (${ssrInterpolate(unref(selected).tasks.level6?.baseNetwork)}/${ssrInterpolate(unref(selected).tasks.level6?.baseCidr)})</p><!--[-->`);
              ssrRenderList(unref(selected).tasks.level6?.subnets, (s, i) => {
                _push2(`<p class="font-mono text-gray-600"${_scopeId}>${ssrInterpolate(s.name)} (${ssrInterpolate(s.hosts)} hosts): ${ssrInterpolate(s.networkAddr)}/${ssrInterpolate(s.cidr)}, ${ssrInterpolate(s.mask)}, BC: ${ssrInterpolate(s.broadcastAddr)}</p>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              return [
                createVNode("div", { class: "space-y-4 text-sm" }, [
                  createVNode("div", null, [
                    createVNode("p", { class: "font-semibold text-gray-700 mb-1" }, "Level 1 – Binary→Decimal"),
                    createVNode("p", { class: "font-mono text-gray-600" }, toDisplayString(unref(selected).tasks.level1?.[0]?.binary) + " → " + toDisplayString(unref(selected).tasks.level1?.[0]?.decimal), 1)
                  ]),
                  createVNode("div", null, [
                    createVNode("p", { class: "font-semibold text-gray-700 mb-1" }, "Level 2 – IP Class"),
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(selected).tasks.level2, (t, i) => {
                      return openBlock(), createBlock("p", {
                        class: "font-mono text-gray-600",
                        key: i
                      }, toDisplayString(t.ip) + " → " + toDisplayString(t.class), 1);
                    }), 128))
                  ]),
                  createVNode("div", null, [
                    createVNode("p", { class: "font-semibold text-gray-700 mb-1" }, "Level 3 – Network/Broadcast"),
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(selected).tasks.level3, (t, i) => {
                      return openBlock(), createBlock("p", {
                        class: "font-mono text-gray-600",
                        key: i
                      }, toDisplayString(t.hostIp) + " → Net: " + toDisplayString(t.networkAddr) + ", BC: " + toDisplayString(t.broadcastAddr), 1);
                    }), 128))
                  ]),
                  createVNode("div", null, [
                    createVNode("p", { class: "font-semibold text-gray-700 mb-1" }, "Level 4 – Host Count"),
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(selected).tasks.level4, (t, i) => {
                      return openBlock(), createBlock("p", {
                        class: "font-mono text-gray-600",
                        key: i
                      }, toDisplayString(t.mask) + " → " + toDisplayString(t.hostCount) + " hosts", 1);
                    }), 128))
                  ]),
                  createVNode("div", null, [
                    createVNode("p", { class: "font-semibold text-gray-700 mb-1" }, "Level 5 – Same Network"),
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(selected).tasks.level5, (t, i) => {
                      return openBlock(), createBlock("p", {
                        class: "font-mono text-gray-600",
                        key: i
                      }, toDisplayString(t.ip1) + " & " + toDisplayString(t.ip2) + " / " + toDisplayString(t.mask) + " → " + toDisplayString(t.sameNetwork ? "Yes" : "No"), 1);
                    }), 128))
                  ]),
                  createVNode("div", null, [
                    createVNode("p", { class: "font-semibold text-gray-700 mb-1" }, "Level 6 – VLSM (" + toDisplayString(unref(selected).tasks.level6?.baseNetwork) + "/" + toDisplayString(unref(selected).tasks.level6?.baseCidr) + ")", 1),
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(selected).tasks.level6?.subnets, (s, i) => {
                      return openBlock(), createBlock("p", {
                        class: "font-mono text-gray-600",
                        key: i
                      }, toDisplayString(s.name) + " (" + toDisplayString(s.hosts) + " hosts): " + toDisplayString(s.networkAddr) + "/" + toDisplayString(s.cidr) + ", " + toDisplayString(s.mask) + ", BC: " + toDisplayString(s.broadcastAddr), 1);
                    }), 128))
                  ])
                ])
              ];
...
//# sourceMappingURL=results-GuzskJVQ.js.map
