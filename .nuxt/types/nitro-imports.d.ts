declare global {
  ...
  const binaryToDecimal: typeof import('../../server/utils/ipv4').binaryToDecimal
  const binaryToIp: typeof import('../../server/utils/ipv4').binaryToIp
  const cachedEventHandler: typeof import('../../node_modules/nitropack/dist/runtime/internal/cache').cachedEventHandler
  const cachedFunction: typeof import('../../node_modules/nitropack/dist/runtime/internal/cache').cachedFunction
  const callNodeListener: typeof import('../../node_modules/h3').callNodeListener
  const cidrToSubnetMask: typeof import('../../server/utils/ipv4').cidrToSubnetMask
  const clearResponseHeaders: typeof import('../../node_modules/h3').clearResponseHeaders
  const clearSession: typeof import('../../node_modules/h3').clearSession
  const compareIps: typeof import('../../server/utils/ipv4').compareIps
  ...
  const decimalToBinary: typeof import('../../server/utils/ipv4').decimalToBinary
  ...
  const generateRandomCidr: typeof import('../../server/utils/ipv4').generateRandomCidr
  const generateRandomIp: typeof import('../../server/utils/ipv4').generateRandomIp
  const generateRandomSubnetMask: typeof import('../../server/utils/ipv4').generateRandomSubnetMask
  const getBroadcastAddress: typeof import('../../server/utils/ipv4').getBroadcastAddress
  const getCookie: typeof import('../../node_modules/h3').getCookie
  const getDb: typeof import('../../server/utils/db').getDb
  const getHeader: typeof import('../../node_modules/h3').getHeader
  const getHeaders: typeof import('../../node_modules/h3').getHeaders
  const getHostCount: typeof import('../../server/utils/ipv4').getHostCount
  const getHostCountFromMask: typeof import('../../server/utils/ipv4').getHostCountFromMask
  const getIpClass: typeof import('../../server/utils/ipv4').getIpClass
  const getMethod: typeof import('../../node_modules/h3').getMethod
  const getNetworkAddress: typeof import('../../server/utils/ipv4').getNetworkAddress
  ...
  const ipToBinary: typeof import('../../server/utils/ipv4').ipToBinary
  ...
  const isValidIp: typeof import('../../server/utils/ipv4').isValidIp
  const isWebResponse: typeof import('../../node_modules/h3').isWebResponse
  const lazyEventHandler: typeof import('../../node_modules/h3').lazyEventHandler
  const nitroPlugin: typeof import('../../node_modules/nitropack/dist/runtime/internal/plugin').nitroPlugin
  const normalizeIp: typeof import('../../server/utils/ipv4').normalizeIp
  ...
  const sameNetwork: typeof import('../../server/utils/ipv4').sameNetwork
  ...
  const subnetMaskToCidr: typeof import('../../server/utils/ipv4').subnetMaskToCidr
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/runner/work/ipv4/ipv4/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/home/runner/work/ipv4/ipv4/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getDb } from '/home/runner/work/ipv4/ipv4/server/utils/db';
export { decimalToBinary, binaryToDecimal, ipToBinary, binaryToIp, getIpClass, cidrToSubnetMask, subnetMaskToCidr, getNetworkAddress, getBroadcastAddress, getHostCount, getHostCountFromMask, sameNetwork, isValidIp, normalizeIp, compareIps, generateRandomIp, generateRandomCidr, generateRandomSubnetMask } from '/home/runner/work/ipv4/ipv4/server/utils/ipv4';